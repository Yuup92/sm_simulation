...
int BasicMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "childrenIds")==0) return base+18;
    if (fieldName[0]=='d' && strcmp(fieldName, "depth")==0) return base+19;
    if (fieldName[0]=='e' && strcmp(fieldName, "endNodeId")==0) return base+20;
    if (fieldName[0]=='a' && strcmp(fieldName, "amount")==0) return base+21;
    if (fieldName[0]=='t' && strcmp(fieldName, "transactionId")==0) return base+22;
    if (fieldName[0]=='n' && strcmp(fieldName, "neighbourhoodIndex")==0) return base+23;
    if (fieldName[0]=='i' && strcmp(fieldName, "inspection")==0) return base+24;
    if (fieldName[0]=='l' && strcmp(fieldName, "lowestIdFragment")==0) return base+25;
    if (fieldName[0]=='r' && strcmp(fieldName, "rootNodeId")==0) return base+26;
    if (fieldName[0]=='l' && strcmp(fieldName, "leaderId")==0) return base+27;
    if (fieldName[0]=='a' && strcmp(fieldName, "ack")==0) return base+28;
    if (fieldName[0]=='r' && strcmp(fieldName, "root_node")==0) return base+29;
    if (fieldName[0]=='s' && strcmp(fieldName, "start_spanning_tree")==0) return base+30;
    if (fieldName[0]=='s' && strcmp(fieldName, "spanning_request")==0) return base+31;
    if (fieldName[0]=='s' && strcmp(fieldName, "spanning_request_ack")==0) return base+32;
    if (fieldName[0]=='s' && strcmp(fieldName, "spanning_tree_level")==0) return base+33;
    if (fieldName[0]=='s' && strcmp(fieldName, "spanning_decline_request")==0) return base+34;
    if (fieldName[0]=='d' && strcmp(fieldName, "down_broadcast")==0) return base+35;
    if (fieldName[0]=='u' && strcmp(fieldName, "up_broadcast_reply")==0) return base+36;
...
std::string BasicMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 18: return oppstring2string(pp->getChildrenIds());
        case 19: return long2string(pp->getDepth());
        case 20: return long2string(pp->getEndNodeId());
        case 21: return long2string(pp->getAmount());
        case 22: return long2string(pp->getTransactionId());
        case 23: return long2string(pp->getNeighbourhoodIndex());
        case 24: return long2string(pp->getInspection());
        case 25: return long2string(pp->getLowestIdFragment());
        case 26: return long2string(pp->getRootNodeId());
        case 27: return long2string(pp->getLeaderId());
        case 28: return bool2string(pp->getAck());
        case 29: return long2string(pp->getRoot_node());
        case 30: return bool2string(pp->getStart_spanning_tree());
        case 31: return bool2string(pp->getSpanning_request());
        case 32: return bool2string(pp->getSpanning_request_ack());
        case 33: return long2string(pp->getSpanning_tree_level());
        case 34: return bool2string(pp->getSpanning_decline_request());
        case 35: return bool2string(pp->getDown_broadcast());
        case 36: return bool2string(pp->getUp_broadcast_reply());
        default: return "";
    }
}
...
bool BasicMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 18: pp->setChildrenIds((value)); return true;
        case 19: pp->setDepth(string2long(value)); return true;
        case 20: pp->setEndNodeId(string2long(value)); return true;
        case 21: pp->setAmount(string2long(value)); return true;
        case 22: pp->setTransactionId(string2long(value)); return true;
        case 23: pp->setNeighbourhoodIndex(string2long(value)); return true;
        case 24: pp->setInspection(string2long(value)); return true;
        case 25: pp->setLowestIdFragment(string2long(value)); return true;
        case 26: pp->setRootNodeId(string2long(value)); return true;
        case 27: pp->setLeaderId(string2long(value)); return true;
        case 28: pp->setAck(string2bool(value)); return true;
        case 29: pp->setRoot_node(string2long(value)); return true;
        case 30: pp->setStart_spanning_tree(string2bool(value)); return true;
        case 31: pp->setSpanning_request(string2bool(value)); return true;
        case 32: pp->setSpanning_request_ack(string2bool(value)); return true;
        case 33: pp->setSpanning_tree_level(string2long(value)); return true;
        case 34: pp->setSpanning_decline_request(string2bool(value)); return true;
        case 35: pp->setDown_broadcast(string2bool(value)); return true;
        case 36: pp->setUp_broadcast_reply(string2bool(value)); return true;
